...
<div class="sidebar col-md-2 d-flex flex-column justify-content-between py-5 px-4">
    ...
    <li><a href="./dashboard.php"><button class="btn btn-primary btn-rounded">Home</button></a></li>
    <?php if($_SESSION['role'] === 'admin') { ?>
        ...
        <!-- rider -->
        <div>
            <li><a href="../../controller/queries/addFirstAid.php"><button class="btn btn-primary">First Aid Request</button></a></li>
    ...
    <div>
        ...
        <br>
        <a href="../../controller/queries/logout.php"><button class="btn btn-danger">Logout</button></a>
    </div>
</div>