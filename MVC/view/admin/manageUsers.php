...
require_once('../../controller/queries/showUsers.php');
?>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="../../controller/queries/deleteUser.php?id=<?php echo $row['id'] ?>"><button class="btn btn-danger ms-3">Delete</button></a>
                            </td>
                        </tr>
                    <?php
                    }
