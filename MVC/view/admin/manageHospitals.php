...
require_once('../../controller/queries/showHospitals.php');
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="../../controller/queries/deleteHospital.php?id=<?php echo $row['id'] ?>"><button class="btn btn-danger ms-3">Delete</button></a>
                            </td>
                        </tr>
                    <?php
                    }
